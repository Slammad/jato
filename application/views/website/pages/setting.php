                    ...
                    <div class="col-md-12 col-sm-12">
                        <?php echo form_open_multipart('website/setting/create','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <textarea name="description" class="form-control"  placeholder="Description" rows="2"><?php echo $setting->description ?></textarea>
                                </div>
                            </div> 

                            <div class="form-group row">
                                <label for="meta_tag" class="col-xs-3 col-form-label">Meta Tag</label>
                                <div class="col-xs-9">
                                    <textarea name="meta_tag" class="form-control"  placeholder="Meta Tag" rows="2"><?php echo $setting->meta_tag ?></textarea>
                                </div>
                            </div> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <textarea name="meta_keyword" class="form-control"  placeholder="Meta Description" rows="2"> <?php echo $setting->meta_keyword ?></textarea>
                                </div>
                            </div>                             
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <textarea name="address" class="form-control"  placeholder="Address" rows="2"><?php echo $setting->address ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input type="file" name="logo" placeholder="Logo" id="logo" value="<?php echo $setting->logo ?>">
                            ...
                            <div class="form-group row">
                                <label for="copyright_text" class="col-xs-3 col-form-label">Copyright Text</label>
                                <div class="col-xs-9">
                                    <textarea name="copyright_text" class="form-control tinymce"  placeholder="Copyright Text" rows="2"><?php echo $setting->copyright_text ?></textarea>
                                </div>
                            </div>  
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <textarea name="twitter_api" class="form-control"  placeholder="Twitter Api" rows="2"><?php echo $setting->twitter_api ?></textarea>
                                </div>
                            </div>  
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <textarea name="google_map" class="form-control"  placeholder="Google Map" rows="2"><?php echo $setting->google_map ?></textarea>
                                </div>
                            </div>  

                            <div class="form-group row">
                                <label for="facebook" class="col-xs-3 col-form-label">Facebook</label>
                                <div class="col-xs-9">
                            ...
                            <div class="form-group row">
                                <label for="twitter" class="col-xs-3 col-form-label">Twitter</label>
                                <div class="col-xs-9">
                            ...
                            <div class="form-group row">
                                <label for="instagram" class="col-xs-3 col-form-label">Instagram</label>
                                <div class="col-xs-9">
                            ...
                            <div class="form-group row">
                                <label for="google_plus" class="col-xs-3 col-form-label">Google Plus</label>
                                <div class="col-xs-9">
                            ...
                            <div class="form-group row">
                                <label for="dribbble" class="col-xs-3 col-form-label">Dribbble</label>
                                <div class="col-xs-9">
                            ...
                            <div class="form-group row">
                                <label for="skype" class="col-xs-3 col-form-label">Skype</label>
                                <div class="col-xs-9">
                            ...
                            <div class="form-group row">
                                <label for="vimeo" class="col-xs-3 col-form-label">Vimeo</label>
                                <div class="col-xs-9">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3">Website Status</label>
                                <div class="col-xs-9">
                                    <div class="form-check">
                                        <label class="radio-inline">
                                        <input type="radio" name="status" value="1"  <?= ($setting->status==1?"checked":null) ?> >Active
                                        </label>
                                        <label class="radio-inline">
                                        <input type="radio" name="status" value="0" <?= ($setting->status==0?"checked":null) ?> >Inactive
                                        </label>
                                    </div>
                                </div>
                            </div>
