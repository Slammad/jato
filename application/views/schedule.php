                        ...
                        <?php if (!empty($schedules)) { ?>
                            ...
                            <?php foreach ($schedules as $schedule) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td class="center">
                                        <a href="<?php echo base_url("schedule/edit/$schedule->schedule_id") ?>" class="btn btn-xs block btn-warning">Edit</a> 
                                        <a href="<?php echo base_url("schedule/delete/$schedule->schedule_id") ?>" onclick="return confirm('Are you sure ?')" class="btn btn-xs block btn-danger">Delete</a> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
